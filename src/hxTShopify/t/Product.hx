...
abstract ProductWrapper( Product ) to Product {
    public inline function new( p: Product ) {
        ...
        for( i in 0...this.images.length   ) this.images[ i ]   = new ImageWrapper( this.images[ i ] );
        for( i in 0...this.options.length  ) this.options[ i ]  = new OptionWrapper( this.options[ i ] );
        for( i in 0...this.variants.length ) this.variants[ i ] = new VariantWrapper( this.variants[ i ] );
